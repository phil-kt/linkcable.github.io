...
var Stokr = React.createClass({
    ...
    render: function() {
        ...
        return (
            <Carousel decorators={Decorators} framePadding="0px 40px" className="about-stokr hidden">
                <div className="stokr-profile copy ">
                    <p className="stokr-wordmark wordmark"></p>
                    <p className="para">
                    ...
                    <p className="para">
                        I was responsible for creating the webapp and branding for stokr. The name comes from "stoker", as in the person who shovels coal on a steam engine. The logo itself is meant to evoke the image of steam coming out of a locomotive. We ended up winning Hack the North with our app!
                    </p>
